...
pacstrap_pkgs="${pacstrap_pkgs} pipewire pipewire-alsa pipewire-pulse wireplumber pavucontrol" # audio
...
pacstrap_pkgs="${pacstrap_pkgs} neovim fzf ctags ripgrep feh sxiv git github-cli jq bzip2 unzip" # etc
pacstrap_pkgs="${pacstrap_pkgs} intellij-idea-community-edition" # etc
