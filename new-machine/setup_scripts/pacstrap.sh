...
pacstrap_pkgs="${pacstrap_pkgs} xorg-server xorg-xinit xorg-xbacklight xorg-xrandr xautolock xclip scrot dmenu" # for desktop env
...
pacstrap_pkgs="${pacstrap_pkgs} alsa-utils pulseaudio pulseeffects pavucontrol" # audio
...
pacstrap_pkgs="${pacstrap_pkgs} neovim fzf ctags the_silver_searcher feh sxiv git hub jq bzip2 unzip" # etc
